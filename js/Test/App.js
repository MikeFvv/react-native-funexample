...
const Hometest2 = require('../res/ic_hometest2_active.png');
const ThelotIcon = require('../res/ic_tabbar_thelot_active.png');
const MeIcon = require('../res/ic_tabbar_me_active.png');
...
const MyTab = TabNavigator({
    Test1: {
        ...
        navigationOptions: ({ navigation, screenProps }) => ({
            ...
            tabBarIcon: (({ tintColor, focused }) => {
                return (
                    <Image
                        source={!focused ? Hometest2 : Hometest2}
    ...
    Test3: {
        screen: Test3,
        navigationOptions: () => TabOptions('我的', MeIcon, MeIcon, '我的'),
    },
}, {
